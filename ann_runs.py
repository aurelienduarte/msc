...
for i in range(0,10,1):
    ...
    with open('runs/'+str(i)+'_ip2.nmap.online.hosts.masscan.csv.optimised.classifier.16.map6', 'wb') as outfile:
        pickle.dump(classifier, outfile)

    with open('runs/'+str(i)+'_ip2.nmap.online.hosts.masscan.csv.optimised.test.16.map6', 'wb') as outfile:
        pickle.dump(X_test, outfile)

    with open('runs/'+str(i)+'_ip2.nmap.online.hosts.masscan.csv.optimised.train.16.map6', 'wb') as outfile:
        pickle.dump(X_train, outfile)

    with open('runs/'+str(i)+'_ip2.nmap.online.hosts.masscan.csv.optimised.clusters.16.map6', 'wb') as outfile:
